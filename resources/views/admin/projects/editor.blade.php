            ...
            <div class="card-body">
                ...
                <form method="POST" enctype="multipart/form-data">
                    ...
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10">
                            <input type="text" name="title" placeholder="service name here" value="{{ $project->title??'' }}" required class="form-control">
                        </div>
                    </div>
                    <div class="row mb-3">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Caption</label>
                        <div class="col-sm-10">
                            <input type="text" name="caption" required placeholder="service caption here" value="{{ $project->caption??'' }}" class="form-control" id="inputEmail">
                        </div>
                    </div>
                    <div class="row mb-3">
                        ...
                        <div class="col-sm-10 row">
                            <div class="col-lg-6">
                                <div class="container-fluid px-0 mx-0">
                                    <img class="img img-thumbnail img-fluid" id="featured_image_tag" src="{{ ($project->featured_image??null) == null ? asset('admin/assets/img/news-5.jpg') : $project->featured_image }}">
                                </div>
                            </div>
                        ...
                        <div class="col-sm-10">
                            <div class="card p-0">
                                <div class="card-body p-0">
                                    <!-- TinyMCE Editor -->
                                    <textarea class="tinymce-editor" requried name="description" placeholder="Provide project details here">
                                        {!! $project->description??'' !!}
